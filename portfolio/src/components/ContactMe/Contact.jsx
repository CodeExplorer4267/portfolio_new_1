    ...
    <div className="h-[500px] w-[100%] flex flex-col items-center pb-[20px] ">
      ...
      <div className="flex flex-row justify-evenly items-center gap-[300px]">
        ...
        <div className=" flex flex-col gap-[20px] justify-center items-center">
          ...
          <input type="text" name="" id="" placeholder="Enter name" className="w-[350px] border border-purple-500 p-[15px] rounded-2xl"/>
          <input type="text" name="" id="" placeholder="Enter email" className="w-[350px] border border-purple-500 p-[15px] rounded-2xl"/>
          <textarea type="text" name="" id="" rows={4} placeholder="Enter Your Thoughts" className="w-[350px] border border-purple-500 p-[15px] rounded-2xl"/>
