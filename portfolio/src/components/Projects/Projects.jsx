          ...
          <div className="first w-[90%] h-[400px] flex flex-row justify-evenly items-center">
            ...
            >
              ...
              <p className="text-white text-[14px] block">
                My online examination website is a full-stack platform built
                using (MySQL, Express.js, React.js, Node.js).It includes
                separate portals for teachers and students, allowing teachers to
                create exams , add SAQs, and view detailed results. Students can
                join exams, answer questions within a timer, and view their
                results. The platform supports real-time chat via WebSockets and
                integrates AI to generate exam questions. It ensures secure and
                efficient online assessments with features like result uploads,
                and answer reviews.Teachers can also upload materials for
                students.
              </p>
          ...
          <div className="first w-[90%] h-[400px] flex flex-row justify-evenly items-center">
            <div className="flex flex-col items-center gap-[40px] w-[40%] p-[5px]">
              ...
              <p className="text-white text-[14px] block">
                ...
                <br />
                6.Profile View: Access and manage your own posts, saved items,
                and replies.
                <br />
          ...
          <div className="first w-[90%] h-[400px] flex flex-row justify-evenly items-center">
            ...
            <div className="flex flex-col items-center gap-[40px] w-[40%] p-[5px]">
              ...
              <p className="text-white text-[14px] block">
                ...
                including profile picture updates, and a dummy payment system.
                An admin panel enables management of food items and real-time
                order status updates. Image uploads are handled via Multer, and
                Context API is used for efficient state management across
                components.
              </p>
              <div className="flex flex-row gap-6 justify-center items-center text-center w-[100%]">
                <h2 className="text-violet-600 font-bold text-[20px]">
