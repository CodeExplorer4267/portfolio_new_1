        ...
        <div className="flex flex-col justify-center items-center gap-[30px] h-[100%] w-[40%] p-[15px]">
          ...
          <div className="flex flex-row justify-center items-center gap-[10px] p-[5px] text-white text-1xl w-[100%] flex-wrap text-center">
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[0].logo} alt="" className="h-[40px] w-auto"/>
                <p>HTML</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[1].logo} alt="" className="h-[40px] w-auto"/>
                <p>CSS</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[3].logo} alt="" className="h-[40px] w-auto"/>
                <p>Java Script</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[4].logo} alt="" className="h-[40px] w-auto"/>
                <p>React</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[8].logo} alt="" className="h-[40px] w-auto"/>
                <p>Tailwind CSS</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[2].logo} alt="" className="h-[40px] w-auto"/>
                <p>SASS</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src="./framer_motion_logo.png" alt="" className="h-[35px] w-auto"/>
                <p>Framer Motion</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[9].logo} alt="" className="h-[40px] w-auto"/>
                <p>GSAP</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[10].logo} alt="" className="h-[30px] w-auto" />
                <p>Material UI</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[1].skills[1].logo} alt="" className="h-[30px] w-auto" />
                <p>Node Js</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[1].skills[2].logo} alt="" className="h-[30px] w-auto" />
                <p>Express Js</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[1].skills[4].logo} alt="" className="h-[30px] w-auto" />
                <p>MongoDB</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[1].skills[3].logo} alt="" className="h-[30px] w-auto" />
                <p>My SQL </p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src="cloudinary_logo.png" alt="" className="h-[30px] w-auto" />
                <p>Cloudinary</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src={SkillsInfo[0].skills[6].logo} alt="" className="h-[30px] w-auto" />
                <p>Redux</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src="socket_Io_logo.png" alt="" className="h-[30px] w-auto" />
                <p>Socket IO</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
             ...
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src="network_logo.jpg" alt="" className="h-[30px] w-auto" />
                <p>Networks</p>
             </div>
             <div className="flex flex-col justify-center items-center gap-[5px]">
                <img src="database_logo.avif" alt="" className="h-[30px] w-auto" />
